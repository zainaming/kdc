...
const PageHeader = ({ label, title, description, lastUpdated, backgroundImage }) => {
  return (
    <section
      className="relative max-w-7xl mx-auto min-h-[320px] sm:min-h-[380px] md:min-h-[420px] lg:min-h-[580px] flex items-center bg-cover bg-top mt-16 md:mt-0 bg-no-repeat overflow-hidden"
