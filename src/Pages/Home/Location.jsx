...
const Location = () => {
  return (
    <div className="bg-[#FAF4EB] max-w-[1600px] mx-auto">
      <div className="bg-[#FAF4EB] relative flex items-center justify-center mb-16">
        <div className="w-full h-[2px] bg-[#A47551]"></div>

        <div className="absolute bg-[#FAF4EB] px-4 flex items-center justify-center">
          <Icon icon="noto:eyes" className="text-4xl md:text-5xl" />
        </div>
      </div>
      ...
      <div className=" mx-auto flex flex-col gap-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#7A726E] text-sm md:text-base leading-relaxed mt-2">
              Located in a well-connected area of Palm Bay for easy access to
          ...
          <div className="bg-[#FAF4EB] border border-[#EBE3D5] rounded-[2rem] p-8 md:p-10 h-full flex flex-col justify-center shadow-[0_4px_25px_rgba(0,0,0,0.01)]">
            ...
            <p className="text-[#5C5552] text-xs md:text-sm leading-relaxed font-light">
              Conveniently located in Palm Bay, KDC Serenity Home is just
              minutes away from urgent care centers, hospitals, shopping
              centers, restaurants, barber shops, salons, and other personal
              care services. With quick access to major transportation routes,
              including I-95, residents enjoy seamless connectivity to
              healthcare, community activities, and everyday
              essentials—supporting independence, comfort, and an enhanced
              quality of life.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-[#A47551] font-medium text-sm md:text-base px-4">
            At KDC Serenity Home, we are committed to creating a supportive,
            respectful, and enriching environment
          </p>
        </div>
      </div>
    </div>
