...
const Homeimg = () => {
  ...
  return (
    <section className="container2 relative w-full pt-10 md:mt-28 mt-8 pb-16 px-4 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[35%] h-[20%] bg-[#FBF4EC] -z-10 hidden md:block" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center relative">
        ...
        <div className="md:col-span-6 flex flex-col items-start text-left z-10 space-y-6">
          ...
          <h1 className="text-[#2D2621] font-serif font-bold text-4xl sm:text-5xl md:text-6xl lg:text-[70px] leading-[1.1] tracking-tight max-w-xs sm:max-w-md md:max-w-lg z-20 pointer-events-none select-none">
            KDC Serenity <span className="block">Home</span>
          </h1>

          {/* Subheading with highlighted text */}
          <div className="space-y-4 pt-4 md:pt-8 max-w-lg">
            <Typography className="text-[#2D2621] text-lg md:text-lg font-bold leading-snug">
        ...
        {/* Right Image Column */}
        <div className="md:col-span-6 w-full h-[350px] sm:h-[350px] md:h-[450px] rounded-bl-[40px] md:rounded-bl-[80px] overflow-hidden shadow-sm z-0">
          <img
