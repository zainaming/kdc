...
const Homeimg = () => {
  return (
    <section className="container2 relative w-full pt-10 md:mt-28 pb-16 px-4 max-w-7xl mx-auto overflow-hidden">
  ...
  KDC Serenity <span className="block">Home</span>
          ...
          <div className="space-y-4 pt-4 md:pt-8 max-w-lg">
            ...
            <Typography className="text-[#6B5E55] text-sm md:text-base leading-relaxed font-normal">
              ...
              living homes designed to help individuals transition from treatment 
